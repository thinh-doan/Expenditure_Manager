...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cbbCategory.setItemText(0, _translate("Dialog", "Salary"))
        self.cbbCategory.setItemText(1, _translate("Dialog", "Allowance"))
        self.cbbCategory.setItemText(2, _translate("Dialog", "Full-time job"))
        self.cbbCategory.setItemText(3, _translate("Dialog", "Part-time job"))
